---
title: "Guide: understand unit economics in one day, with examples"
source: https://www.linkedin.com/pulse/guide-understand-unit-economics-one-day-examples-ki-professionals
author: KI professionals GmbH
modules: [M1.3]
...
*Автор: KI professionals GmbH*  
*Источник: https://www.linkedin.com/pulse/guide-understand-unit-economics-one-day-examples-ki-professionals*

![Guide: understand unit economics in one day, with examples](https://media.licdn.com/dms/image/v2/D4E12AQFMHNlfr9u6NA/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1693990837123?e=2147483647&v=beta&t=Oio5pCZiwtbE1zGDSqcRhcykPRyjPCbkHPbNCP_qWq4)
...
[KI professionals GmbH](https://de.linkedin.com/company/ki-professionals)
![KI professionals GmbH]()
...
[+ Follow](https://www.linkedin.com/signup/cold-join?session_redirect=%2Fpulse%2Fguide-understand-unit-economics-one-day-examples-ki-professionals&trk=article-ssr-frontend-pulse_publisher-author-card)

by Aleksandr Palchikov

In a nutshell, this article is about:

- How to evaluate the success of a business.
- How to make product and business decisions based on numbers

Copy Unit-Economics Glossary for your team in Notion. The link is in [Telegram.](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Ft%2Eme%2Falex_palchikov&urlhash=G2BY&trk=article-ssr-frontend-pulse_little-text-block)
...
- Everyone who works in IT and is responsible for product, sales, marketing, and operations needs to understand which actions will lead to desirable metrics. Product managers can learn how to identify flaws and points of growth, sometimes even multiple points of growth, and focus on them. They can propose and evaluate the cost of developing hypotheses and assess their economic impact.
- Individuals planning to start a business and evaluating their idea with a complicated Excel financial forecast model for the next three to five years. By learning to evaluate your business ideas within an hour and make decisions based on economic metrics, you can avoid spending two years developing a product with non-viable economics.
- Investors consider unit economics a crucial metric when evaluating business health, and they often rely on it to make informed investment decisions. Unit economics enables them to assess Return on Marketing Investment (ROMI) and Return on Investment (ROI) as well.
- Note 1: The unit economics approach can be challenging for companies with complex cost systems, such as manufacturing, medical, and scientific projects.
- Note 2: The unit economics approach cannot be applied in project-related companies such as consulting, development studios, or design studios because each new project is a unique product with completely different processes. The unit economics approach is designed for scalable (recurring user scenarios) products.

### What is unit economics?

Unit economics answers whether you earn on your user (unit) or not. To understand this, you need to find out:

- How much money did you spend on attracting this user;
- How much money you earned from this user.
...
- Users attracted in March;
- Users attracted in March from Facebook ads;
- iOS users in Germany recruited in March from Facebook ads;
- And so on.
...
- AMPU > CPUser - unit economics "converges". You earn more from users than you spend on attracting them;
- AMPU < CPUser - unit economics "does not converge". You earn less from users than you spend on attracting them.

If you don't know the AMPU and CPUser metrics, you will need to perform the following steps for a specific user cohort:

1. You need to implement end-to-end analytics. To make calculations clean, you need to count each channel separatelyfor each acquisition channel (Organic, Google, Facebook, Instagram…),for each type of device (web, mobile),for each group of users: old and new. All necessary fields you will find here: Link on TG.
...
### Okay, but why do we need buzzwords like UA, C1, C2, COGS, COGS1\_1st Sale, APC, ARPC, AMPU, AMPPU, AC?
...
- Income per customer (payer)
- The income per attracted visitor
- Financial metrics

![Article content]()

Now you can open [Excel](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Fdocs%2Egoogle%2Ecom%2Fspreadsheets%2Fd%2F1EtbZusVxdn1t9mTjAnAwX6Ohu3yKCBISacncoz3kdR8%2Fedit%3Fusp%3Dsharing&urlhash=b5dt&trk=article-ssr-frontend-pulse_little-text-block) and actively engage with the figures and concepts presented. I have created a simplified [Google Sheet Framework Template](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Fdocs%2Egoogle%2Ecom%2Fspreadsheets%2Fd%2F1EtbZusVxdn1t9mTjAnAwX6Ohu3yKCBISacncoz3kdR8%2Fedit%23gid%3D1425958817&urlhash=8FcJ&trk=article-ssr-frontend-pulse_little-text-block) with actual business figures. To maintain anonymity, I have included a factor that allows you to adjust the ratios. I have used Iliya Krasinski's framework within the unit economics realm as it is user-friendly and straightforward.

When you come across incomprehensible words, look for them in [Glossary](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Fwww%2Enotion%2Eso%2F6bc0777763884d218669b8f132e3600a%3Fpvs%3D21&urlhash=RZOU&trk=article-ssr-frontend-pulse_little-text-block). The Glossary includes all the essential metrics you can readily apply to your company.
...
[Sheet 1 in Excel.](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Fdocs%2Egoogle%2Ecom%2Fspreadsheets%2Fd%2F1EtbZusVxdn1t9mTjAnAwX6Ohu3yKCBISacncoz3kdR8%2Fedit%23gid%3D1425958817&urlhash=8FcJ&trk=article-ssr-frontend-pulse_little-text-block) Let’s play. You play as a Founder of a music service like Apple Music, and you want to make the world even better and create another music service that will be better than existing solutions.
...
- Since this is a subscription, one customer makes one purchase in 1 month with an average check of 10 EUR (Av. Price = 10 EUR Monthly).
- On each subscription, you earn, say, 30% (Margin = 30%)
- Attracting one user costs you 1 EUR (CPUser or CPLead)
- Conversion into 1st purchase is 1% (C1 = 1%)
...
> Note. Everyone counts conversion in different ways, but How to calculate it right? C1 — or conversion to the buyer should be calculated from user acquisition, not just user registration. Often, teams calculate conversion only for the steps they are responsible for. For example, the marketing team is responsible for leads and registrations, while the product team calculates conversion to the customer from registrations, then: conversion from user → lead = 10% conversion from lead \*→ customers = 11%. So the conversion from user to customer would be = 10%\* × 11\*% = 1,1% —not such a pretty figure for reports, but it clearly shows the problem that only 1,1% of users are converting to customers. This indicates the need to build funnels and identify blockers in the user journey.\*
...
AMPU(30) = Gross Profit / Users = 3,600€ / 1,000 = 0.04€ AMPU(365) = Gross Profit / Users = 21,000€ / 1,000 = 0.21€
...
- At what metric values you will achieve the desired result.
- Which marketing channels you can afford to use.
- That you will most likely not be able to create a profitable music service, saving time and energy to explore other business ideas and products.
- Whether or not to accept a job invitation from a deliberately failed startup.
...
AMPPU = (AvPrice - COGS) × AvPaymentCount
...
2. We can calculate the number of purchases in the paid channel required to achieve positive profitability. Based on the data, we need to:Increase the average payment count to 2.3 per clientIncrease the conversion rate to purchase (C1) to 0.73% by modifying the ad campaign or landing pagePotentially decrease the Cost of Goods Sold (COGS) by 35.50% by negotiating manufacturer discounts through increased wholesale purchases and as well reducing logistic and warehouse costs.
...
You can obtain such a template with explanations on my [TG Channel,](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Ft%2Eme%2Falex_palchikov&urlhash=G2BY&trk=article-ssr-frontend-pulse_little-text-block) which includes anonymized real data from a large billion-dollar company with raw data implementation and cohort analysis.
...
- Venture-backed companies often aim to get back the money spent on raising in 12-18 months (and sometimes more).
- Companies that develop with their own money can rarely afford to wait longer than 2-6 months for the return of money invested in user acquisition.
- For a number of products, LTV reaches a plateau fairly quickly. This means that the inflow of money from attracted customers stopped at a certain point. In these cases, it makes sense to calculate LTV for a month when the curve almost becomes parallel to the X-axis.

### For what month to forecast profit?

The answer to this question depends on the product and the problem being solved.

- Venture-funded companies often aim to get back the money spent on raising in 12-18 months (and sometimes more).
- Companies that develop with their own money can rarely afford to wait longer than 2-6 months for the return of money invested in user acquisition.
- For a number of products, LTV reaches a plateau fairly quickly. This means that the inflow of money from attracted customers stopped at a certain point. In these cases, it makes sense to calculate LTV for a month when the curve almost becomes parallel to the X-axis.
...
One of the difficulties that arise when calculating the unit economics is the task of correct [user attribution](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Fsupport%2Egoogle%2Ecom%2Fanalytics%2Fanswer%2F9397590%3Fhl%3Den%23zippy%3D%252Cin-this-article&urlhash=qm0y&trk=article-ssr-frontend-pulse_little-text-block) of acquisition channels and the related [incremental problem](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Fwww%2Eadroll%2Ecom%2Fblog%2Fbeginners-guide-to-incrementality&urlhash=c5qo&trk=article-ssr-frontend-pulse_little-text-block).
...
If you found the article helpful, please let me know, and feel free to ask any questions via [Telegram](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Ft%2Eme%2Falex_palchikov&urlhash=G2BY&trk=article-ssr-frontend-pulse_little-text-block), or [LinkedIn.](https://www.linkedin.com/in/aleksandr-palchikov/?trk=article-ssr-frontend-pulse_little-text-block) Copy this Article and [Glossary](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Fwww%2Enotion%2Eso%2F6bc0777763884d218669b8f132e3600a%3Fpvs%3D21&urlhash=RZOU&trk=article-ssr-frontend-pulse_little-text-block) for your team in Notion. The link is in [Telegram](https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Ft%2Eme%2Falex_palchikov&urlhash=G2BY&trk=article-ssr-frontend-pulse_little-text-block) as well.
