...
| Чувствительность | P2+ | «что если depth +5 п.п.» в деньгах когорты |
...
- [ ] Лист содержит CAC, цепочку CV, деньги Pro, LTV-допущения, вывод по окупаемости.
- [ ] Узкое место одно; есть явный «не трогаем, пока…».
- [ ] Ядро + одно расширение; в «руках» — чувствительность или пересчёт CAC.
...
- Инвентарь: [`../sources-inventory.md`](../sources-inventory.md) — GoPractice unit-economics / CAC; блиц метрик; плейлист «Испытание 0» как фон моделей (логика, не копипаст листов).
- Офлайн (юнит-экономика): [`../uploads/bonus-gopractice-unit-economics.md`](../uploads/bonus-gopractice-unit-economics.md) · [`../uploads/bonus-vcru-ltv-cac-unit-economics.md`](../uploads/bonus-vcru-ltv-cac-unit-economics.md) · [`../uploads/medium-ki-unit-economics-one-day.md`](../uploads/medium-ki-unit-economics-one-day.md).
- Конверсии и когорты, которыми кормите лист: [`m2-3-conversion-cohorts.md`](./m2-3-conversion-cohorts.md).
- Словарь определений (следующий носитель P1→демо-2): М5.1.
- Стенд и цены: [`../stand/README.md`](../stand/README.md).

Рядом: [`m1-1-problem-market.md`](./m1-1-problem-market.md). Финансы глубже (P&L, LTV финансиста) — М1.4.
